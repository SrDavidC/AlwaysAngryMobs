...
//
//
//public class AngryPolarBear extends net.minecraft.world.entity.animal.PolarBear {
//    public AngryPolarBear(Location loc){
//        super(EntityType.POLAR_BEAR, ((CraftWorld) loc.getWorld()).getHandle());
//
